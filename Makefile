default:
	...
	:     make clean    removes the already compiled 'A-ToGo' files           :
	:                                                                         :
	: ----------------------------------------------------------------------- :
...
A-ToGo32.exe: A-ToGo.cpp A-ToGo.h A-ToGo32.res
	mingw32 c++ -static A-ToGo.cpp A-ToGo32.res -lole32 -o A-ToGo32.exe -mwindows
...
A-ToGo64.exe: A-ToGo.cpp A-ToGo.h A-ToGo64.res
	mingw64 c++ -static A-ToGo.cpp A-ToGo64.res -lole32 -o A-ToGo64.exe -mwindows
